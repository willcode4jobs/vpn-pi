...
gantt
    ...
    axisFormat %b-%d
    todayMarker stroke:#888888,stroke-width:2px,opacity:0.6

    section Key — status
    Done               :done,   leg1, 2026-06-12, 1d
    On track / rework  :active, leg2, 2026-06-12, 1d
    Behind             :crit,   leg3, 2026-06-12, 1d
    Pending            :        leg4, 2026-06-12, 1d

    section Key — phases
    A  Vega ingress + cleanup        :done,   ka, 2026-06-12, 1d
